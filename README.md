...
- [x] 💰 [Banking app](https://github.com/Galaktik-hub/banque-tran): In groups of 5, we are creating an app that lets clients such as companies to manages their bills.
